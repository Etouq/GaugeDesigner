...
Item {
    ...
    Shape {
        ...
        ShapePath {
            ...
            startY: gauge.gaugeData.transformValue
    ...
    Text {
        ...
        color: gauge.gaugeData.color
        text: gauge.gaugeData.value
    }
    ...
    ValueBlinkAnimation {
        ...
        running: gauge.gaugeData.redBlink
        onStopped: function() {
            leftValueText.color = Qt.binding(function() { return gauge.gaugeData.color });
        }
    }
    ...
    ValueBlinkAnimation {
        ...
        running: gauge.gaugeData.redBlink
        onStopped: function() {
            leftMidValueText.color = Qt.binding(function() { return gauge.gaugeData.color });
        }
    }
    ...
    ValueBlinkAnimation {
        ...
        running: gauge.gaugeData.redBlink
        onStopped: function() {
            rightMidValueText.color = Qt.binding(function() { return gauge.gaugeData.color });
        }
    }
    ...
    ValueBlinkAnimation {
        ...
        running: gauge.gaugeData.redBlink
        onStopped: function() {
            rightValueText.color = Qt.binding(function() { return gauge.gaugeData.color });
        }
    }
}
