...
Item {
    ...
    property bool hasElevTrim: aircraftInterface.getHasElevTrim()
    property bool hasRuddTrim: aircraftInterface.getHasRudderTrim()
    property bool hasAilTrim: aircraftInterface.getHasAileronTrim()
